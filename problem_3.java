// Arays - Searching (sorted) Arrays via binary
// 
...
// 6. 0
// 7. 1
// 8. ANS: -1 - Because 1 doesnt exist, we determine it should be 
// inserted at 0 index, however this is taken so we give it -1 position
